...
RSpec.describe User, type: :model do
  ...
  describe 'validations' do
    ...
    it 'requrires the phone attr to only include numbers' do
      @user.phone = 'mygreatstr'
      expect(@user).to_not be_valid
    end

    it 'requires phone attr to only have 10 charachters' do
  ...
  describe 'custom name methods' do
    it 'has a full name that combines first and last name' do
